...
def main():
    ...
    with st.spinner("⏳ Loading model... (first run may take a minute to train)"):
    ...
    with col2:
        ...
        admission_type = st.radio("Admission Type",
    ...
    with col3:
        ...
        billing    = st.number_input("Billing Amount ($)",
                        0.0, 40000.0, 10000.0, step=500.0)
